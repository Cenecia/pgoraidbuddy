...
<div class="container-fluid">
	...
	<div class="card">
		...
		<div class="row text-center">
			<div class="col-12">
				<p class="lead"><strong>This raid expires in <?=$data['timeLeft']?> minutes.</strong></p>
				<?php
	...
	?>
		<h5>
			Attendees 
			<span class="badge badge-default"><?=sizeOf($data['raid']['attendees'])?> <span class='text-success'>(<?=$data['numReady']?>)</span></span>
		...
		<div class="collapse" id="collapseExample">
			<ul class="list-group">
			  ...
			  ?>
			  <?php
				foreach($data['raid']['anon_attendees'] as $attendee){
			  ?>
				<li class="list-group-item <?=$attendee->ready ? "list-group-item-success" : ""?>">
					<span class="badge badge-default" style="background-color:#222224;">
						<img src="../public/img/teams/<?=$attendee->name?>.png" style="width:25px;" />
